...
const Icon = (0, import_index_955b038a.c)(($$result, $$props, $$bindings, slots) => {
  const state = {
    name: "",
    loading: null,
    destroyed: false
  ...
  const onLoad = (icon) => {
    ...
    const dispatch = (0, import_index_955b038a.g)();
    dispatch("load", { icon });
  };
  function loaded2() {
  }
  (0, import_index_955b038a.o)(() => {
  ...
  return `${data !== null ? `<svg${(0, import_index_955b038a.d)([(0, import_index_955b038a.f)(data.attributes)], {})}><!-- HTML_TAG_START -->${data.body}<!-- HTML_TAG_END --></svg>` : ``}`;
});
